...
const SubLabel = ({ children }: { children: React.ReactNode }) => (
  <div className="mb-2 font-mono text-[9px] uppercase tracking-[2px]" style={{ color: FORTRESS.textDim }}>
    {children}
  </div>
);
...
const StatusPill = ({ children }: { children: React.ReactNode }) => (
  <span
    className="rounded-sm border px-2 py-1 font-mono text-[10px] font-extrabold uppercase tracking-[1.5px]"
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        ...
        >
          ...
          <span className="hidden font-mono text-[9px] uppercase tracking-[1px] sm:inline" style={{ color: FORTRESS.textFaint }}>
            ...
            {SECTIONS.map(({ id, label, icon: Icon }) => {
              ...
              return (
                <button
                  ...
                  className="flex items-center gap-2 rounded-sm border px-2.5 py-2 text-left font-mono text-[10px] font-bold uppercase tracking-[1.5px] transition-colors fortress-focus"
                  style={{
          ...
          <div className="min-w-0 flex-1 overflow-y-auto px-[18px] py-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-3 rounded-sm border p-3 sm:flex-row sm:items-center" style={{ borderColor: FORTRESS.border, background: FORTRESS.surfaceRaised }}>
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-mono text-[13px] font-bold tracking-wide" style={{ color: FORTRESS.textBright }}>
                      {profile.callSign || 'Operator'}
                    </div>
                    <div className="truncate font-mono text-[11px]" style={{ color: FORTRESS.textDim }}>
                      {profile.email || 'Email hidden'}
                    </div>
                    <div className="mt-1 flex items-center gap-1.5 font-mono text-[9px] font-bold uppercase tracking-[1.5px]" style={{ color: FORTRESS.green }}>
                    ...
                    <Button
                      ...
                      className="mt-2 h-auto bg-transparent px-2.5 py-1.5 font-mono text-[10px] font-extrabold uppercase tracking-[1.5px] text-green-400 hover:bg-green-500/10"
                ...
                <div className="rounded-sm border p-2.5" style={{ borderColor: FORTRESS.amberBorder, background: alpha(FORTRESS.amber, 0.04) }}>
                  <div className="flex items-start gap-2">
                    ...
                    <div className="font-mono text-[10px] leading-relaxed tracking-wide text-amber-300/80">
                  ...
                  <Button
                    ...
                    className="mt-2.5 h-auto w-full bg-transparent py-1.5 font-mono text-[10px] font-extrabold uppercase tracking-[1.5px] text-amber-300 hover:bg-amber-400/10 disabled:opacity-40"
                ...
                <div className="rounded-sm border p-2.5" style={{ borderColor: FORTRESS.border, background: FORTRESS.surfaceRaised }}>
                  ...
                  <div className="font-mono text-[11px] leading-[1.8] tracking-[2px]" style={{ color: FORTRESS.greenSoft }}>
                    3A7F 09C2 D481 6E5B
                  </div>
                  <div className="mt-2 font-mono text-[10px] uppercase tracking-[1px]" style={{ color: FORTRESS.textFaint }}>
            ...
            {section === 'security' && (
              <div className="flex flex-col gap-2">
                ...
                <div className="rounded-sm border p-2.5 font-mono text-[10px] leading-relaxed" style={{ borderColor: FORTRESS.borderGreen, background: alpha(FORTRESS.green, 0.06), color: FORTRESS.textDim }}>
                ...
                {notifications.reminderTimerEnabled && (
                  <div className="rounded-sm border p-2.5" style={{ borderColor: FORTRESS.border, background: FORTRESS.surfaceSunken }}>
                    ...
                    <Input
                      ...
                      className="h-8 w-24 rounded-sm border font-mono text-[12px]"
                      style={{ borderColor: FORTRESS.border, background: FORTRESS.surfaceRaised, color: FORTRESS.text }}
                    />
                  </div>
                )}
                <div className="rounded-sm border p-2.5 font-mono text-[10px] leading-relaxed" style={{ borderColor: FORTRESS.borderGreen, background: alpha(FORTRESS.green, 0.05), color: FORTRESS.textDim }}>
            ...
            {section === 'calls' && (
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-4 gap-2 text-center font-mono text-[10px] uppercase tracking-wide text-green-400/70">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {ACCENT_SWATCHES.map((color) => (
                      <button
                        ...
                        className="grid h-7 w-10 place-items-center rounded-sm font-mono text-[10px] font-extrabold text-[#06130B] fortress-focus"
                    ...
                    {(['rounded', 'square', 'minimal'] as const).map((bubbleStyle) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          />
                          <div className="text-[10px] font-extrabold uppercase tracking-wide" style={{ color: active ? accent : FORTRESS.textDim }}>
                            {bubbleStyle}
                          </div>
                        </button>
                      );
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {BG_PRESETS.map((background) => (
                      <button
                        ...
                        className="grid h-8 w-12 place-items-center rounded-sm font-mono text-[10px] fortress-focus"
                        style={{
                          background,
                    ...
                    {(['mono', 'sans', 'serif'] as const).map((fontStyle) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mt-1.5 font-mono text-[9px] font-extrabold uppercase tracking-wide" style={{ color: active ? accent : FORTRESS.textDim }}>
                            {fontStyle}
                          </div>
                        </button>
                      );
            ...
            {section === 'about' && (
              <div className="flex flex-col items-center gap-1.5 py-3 text-center">
                ...
                <div className="font-mono text-[10px] uppercase tracking-[2px]" style={{ color: FORTRESS.textFaint }}>
                  Terminal {FORTRESS_VERSION} · Build {FORTRESS_BUILD}
                </div>
                <div className="mt-2.5 max-w-md rounded-sm border p-3 font-mono text-[10px] leading-relaxed tracking-wide" style={{ borderColor: FORTRESS.border, background: FORTRESS.surfaceRaised, color: FORTRESS.textDim }}>
                ...
                <div className="mt-2 grid gap-1.5 text-left font-mono text-[10px] uppercase tracking-wide" style={{ color: FORTRESS.text }}>
                ...
                <div className="mt-3 font-mono text-[9px] uppercase tracking-[0.16em]" style={{ color: FORTRESS.textFaint }}>
        ...
        <div className="flex items-center justify-between border-t px-4 py-3" style={{ borderColor: FORTRESS.borderFaint }}>
          <span className="font-mono text-[9px] uppercase tracking-[1.5px]" style={{ color: FORTRESS.textFaint }}>
            Changes sync to your account settings
          </span>
          <Button
            type="button"
            onClick={onClose}
            className="h-auto rounded-sm px-5 py-2 font-mono text-[11px] font-extrabold uppercase tracking-[2px] text-[#06130B]"
