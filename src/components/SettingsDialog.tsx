          ...
          <div className="min-w-0 flex-1 overflow-y-auto px-[18px] py-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-3 rounded-sm border p-3 sm:flex-row sm:items-center" style={{ borderColor: FORTRESS.border, background: FORTRESS.surfaceRaised }}>
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="truncate font-mono text-[8px]" style={{ color: FORTRESS.textDim }}>
                ...
                <div className="rounded-sm border p-2.5" style={{ borderColor: FORTRESS.amberBorder, background: alpha(FORTRESS.amber, 0.04) }}>
                  <div className="flex items-start gap-2">
                    ...
                    <div className="font-mono text-[8px] leading-relaxed tracking-wide text-amber-300/80">
            ...
            {section === 'security' && (
              <div className="flex flex-col gap-2">
                ...
                <div className="rounded-sm border p-2.5 font-mono text-[8px] leading-relaxed" style={{ borderColor: FORTRESS.borderGreen, background: alpha(FORTRESS.green, 0.06), color: FORTRESS.textDim }}>
                ...
                {notifications.reminderTimerEnabled && (
                  <div className="rounded-sm border p-2.5" style={{ borderColor: FORTRESS.border, background: FORTRESS.surfaceSunken }}>
                    ...
                    <Input
                      ...
                      className="h-8 w-24 rounded-sm border font-mono text-[10px]"
                      style={{ borderColor: FORTRESS.border, background: FORTRESS.surfaceRaised, color: FORTRESS.text }}
                    />
                  </div>
                )}
                <div className="rounded-sm border p-2.5 font-mono text-[8px] leading-relaxed" style={{ borderColor: FORTRESS.borderGreen, background: alpha(FORTRESS.green, 0.05), color: FORTRESS.textDim }}>
                    ...
                    {(['rounded', 'square', 'minimal'] as const).map((bubbleStyle) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          />
                          <div className="text-[8px] font-extrabold uppercase tracking-wide" style={{ color: active ? accent : FORTRESS.textDim }}>
                            {bubbleStyle}
                          </div>
                        </button>
                      );
            ...
            {section === 'about' && (
              <div className="flex flex-col items-center gap-1.5 py-3 text-center">
                ...
                <div className="mt-2 grid gap-1.5 text-left font-mono text-[8px] uppercase tracking-wide" style={{ color: FORTRESS.text }}>
                ...
                <div className="mt-3 font-mono text-[7px] uppercase tracking-[0.16em]" style={{ color: FORTRESS.textFaint }}>
