...
export const ComposerModeBar = ({
  ...
  <div className="flex flex-wrap items-center gap-1.5">
    <span className="font-mono text-[7px] uppercase tracking-[0.22em] text-[#4A5A50]">MARK</span>
      ...
      return (
        <TacticalTooltip key={key} title={meta.tipTitle} body={meta.tipBody} accent={meta.accent}>
          <button
            ...
            className={`fortress-focus rounded-sm border px-2.5 py-1 font-mono text-[8px] font-black uppercase tracking-[0.16em] transition-colors ${
    ...
    >
      <button
        ...
        className={`fortress-focus ml-1 rounded-sm border px-2.5 py-1 font-mono text-[8px] font-black uppercase tracking-[0.16em] transition-colors ${
          burnEnabled
