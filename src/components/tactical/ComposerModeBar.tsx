...
export const ComposerModeBar = ({
  ...
  <div className="flex flex-wrap items-center gap-2">
    <span className="font-mono text-[9px] uppercase tracking-[1.5px] text-[#4A5A50]">MARK</span>
      ...
      return (
        <TacticalTooltip key={key} title={meta.tipTitle} body={meta.tipBody} accent={meta.accent}>
          <button
            ...
            className={`fortress-focus rounded-sm border px-2.5 py-1 font-mono text-[9px] font-extrabold uppercase tracking-[1.5px] transition-colors ${
    ...
    >
      <button
        ...
        className={`fortress-focus ml-1 rounded-sm border px-2.5 py-1 font-mono text-[9px] font-extrabold uppercase tracking-[1.5px] transition-colors ${
          burnEnabled
